...
$(document).ready( function () {
	...
	oTest.fnTest( 
		"Zero records language is 'No se Encontro coincidencias' by default",
		null,
		function () { return oSettings.oLanguage.sZeroRecords == "No se Encontro coincidencias"; }
	);
	
	oTest.fnTest(
		"Text is shown when empty table (after filtering)",
		function () { oTable.fnFilter('nothinghere'); },
		function () { return $('#example tbody tr td')[0].innerHTML == "No se Encontro coincidencias" }
	);
